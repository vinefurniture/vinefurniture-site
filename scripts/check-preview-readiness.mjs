...
const pageChecks = [
  {
    ...
    requiredBindings: [
      ...
      { fragment: 'class="recent-feed-grid recent-feed-grid--six"', label: 'home recent feed grid' },
      { fragment: 'class="recent-feed-tile"', label: 'home recent feed tile', expectedCount: 6 },
