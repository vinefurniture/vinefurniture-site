...
const pageChecks = [
  {
    ...
    requiredBindings: [
      ...
      { fragment: 'class="instagram-feed-frame-wrap instagram-feed-frame-wrap--home"', label: 'home instagram embed wrapper' },
      { fragment: 'title="바인퍼니처 인스타그램 최근 피드"', label: 'home instagram embed iframe' },
